library core;
import 'package:football_premier_league/data/aggregates/aggregates.dart';
import 'package:freezed_annotation/freezed_annotation.dart';
import 'package:football_premier_league/data/matches/matche.dart';

part 'matchResponse.freezed.dart';
part 'matchResponse.g.dart';

@freezed
class MatchResponse with _$MatchResponse {
  factory MatchResponse({
    required Aggregates aggregates,
...
extension MatchResponseX on MatchResponse {
